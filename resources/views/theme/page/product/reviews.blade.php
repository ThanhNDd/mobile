        ...
        <div class="page">
            <div class="navbar navbar-page">
                <div class="navbar-inner sliding">
                    <div class="left">
                        <a href="{{ url("/product-details/123456") }}" class="link back">
            ...
            <div class="page-content hide-navbar-on-scroll">
                ...
                <div class="all-reviews product-review segments">
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <div class="text">
                                ...
                                <ul class="rate-product">
                                    ...
                                    <li><i class="fas fa-star"></i></li>
                                    <li><i class="fas fa-star"></i></li>
                                    <li><i class="fas fa-star-alt"></i></li>
                                </ul>
                                <p class="date">3 min ago</p>
                                <i class="fas fa-thumbs-up like-button"></i>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto, explicabo.</p>
                        ...
                        <div class="content">
                            <img src="{{ url('images/user-buyer4.png') }}" alt="">
                            <div class="text">
                                <h6>Zafaar</h6>
                                <ul class="rate-product">
                                    <li><i class="fas fa-star"></i></li>
                        ...
                        <div class="content">
                            <img src="{{ url('images/user-buyer5.png') }}" alt="">
                            <div class="text">
                                <h6>Abraham</h6>
                                <ul class="rate-product">
                                    <li><i class="fas fa-star"></i></li>
