                    ...
                    <div class="swiper-container swiper-detail-product">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="content">
                                    <div class="mask"></div>
                                    <img src="{{ url('images/product-details1.jpg') }}" alt="">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="content">
                                    <div class="mask"></div>
                                    <img src="{{ url('images/product-details2.jpg') }}" alt="">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="content">
                                    <div class="mask"></div>
                                    <img src="{{ url('images/product-details3.jpg') }}" alt="">
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-40">
                        <div class="content-button">
                            <a href="#" class="button secondary-button"><i class="fas fa-cart-arrow-down"></i>Add to Cart</a>
                        </div>
                    </div>
                    <div class="col-40">
                        <div class="content-button">
                            <a href="#" class="button primary-button"><i class="fas fa-cart-plus"></i>Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
