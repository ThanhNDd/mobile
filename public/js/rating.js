    ...
    n = function () {
        ...
        t.prototype.createStars = function () {
            ...
            for (e = 1, t = this.options.numStars; 1 <= t ? e <= t : e >= t; 1 <= t ? e++ : e--) {
                n.push(this.$el.append("<i class='far fa-star'></i>"))
            }
            return n
        };
        ...
        t.prototype.syncRating = function (e) {
            ...
            if (e) {
                for (t = n = 0, i = e - 1; 0 <= i ? n <= i : n >= i; t = 0 <= i ? ++n : --n) {
                    this.$el.find("i").eq(t).removeClass("far fa-star").addClass("fas fa-star")
                }
            }
            if (e && e < 5) {
                for (t = r = e; e <= 4 ? r <= 4 : r >= 4; t = e <= 4 ? ++r : --r) {
                    this.$el.find("i").eq(t).removeClass("fas fa-star").addClass("far fa-star")
                }
            }
            if (!e) {
